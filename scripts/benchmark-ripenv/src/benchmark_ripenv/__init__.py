"""Benchmark ripenv vs pipenv vs uv.

Reuses the Command/Hyperfine pattern from scripts/benchmark/.
"""
...
class Command(typing.NamedTuple):
    """A single benchmarkable command."""
...
class Hyperfine(typing.NamedTuple):
    """A hyperfine benchmark configuration."""
